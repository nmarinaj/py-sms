...
def response_handler(body):
    ...
    if x == 5:
        return "Happy Saturday, more like Sadder Day. We're gonna miss you guys :( ", "http://science-all.com/images/wallpapers/beautiful-images/beautiful-images-9.jpg"
    if x == 6:
        return "Happy Sunday, I look to a day when people will not be judged by the color of their skin, but by the content of their character.", "http://science-all.com/images/wallpapers/beautiful-images/beautiful-images-8.jpg"
